...
export function HeroSection({ hero, eventDates }: HeroProps) {
  return (
    <>
      {/* Orange Banner */}
      <a 
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-5xl mx-auto">
            ...
            <h1 className="text-6xl lg:text-7xl font-bold mb-6 leading-tight text-gray-900" style={{ fontFamily: "'Playfair Display', serif" }}>
              {hero.headline}<br />
              <span className="text-[#4F46E5]">{hero.highlightedWord}</span> {hero.description}
            </h1>
            ...
            {/* Countdown Timer */}
            <CountdownTimer deadline={eventDates.earlyBirdDeadline} />
          </div>
        </div>
      </section>
    </>
